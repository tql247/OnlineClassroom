    ...
    <main class="container">
        ...
        <div class="app-view">
            ...
            <div class="app-view-controll">
                ...
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#joinClass">
                ...
                <div class="list-card">
                    ...
                    $list_class = $connFilm->query("SELECT * FROM user_class WHERE `user_id` = 1");
                    while ($list_class->num_rows > 0 && $class = $list_class->fetch_assoc()) {
                        $class_detail = $connFilm->query("SELECT * FROM class WHERE `id` = " . $class["class_id"])->fetch_assoc();
                    ?>
